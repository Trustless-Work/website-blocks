      ...
      <div className="container py-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="text-center sm:col-span-2 lg:col-span-1">
              <CardHeader>
                ...
                <CardDescription>
                  Our team reviews and merges approved contributions to the main
                  library.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription className="space-y-2">
                  ...
                  <p className="text-sm">
                    Then visit GitHub to create your Pull Request with detailed
                    information about your component.
                  </p>
                </CardDescription>
              </CardHeader>
            </Card>
              ...
              <div className="space-y-4">
                ...
                <Card>
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription className="text-sm">
                      Product cards, shopping carts, checkout flows, and pricing
                      tables.
                    </CardDescription>
                  </CardHeader>
                </Card>
        ...
        <section className="mt-16 text-center">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground max-w-[600px] mx-auto">
              Connect with other contributors, get feedback on your designs, and
